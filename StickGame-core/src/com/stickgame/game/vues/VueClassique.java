...
public class VueClassique {
	...
	private void chargerTextures(){
		...
		TextureAtlas atlas = new TextureAtlas(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Personnage/Normal/texturesPersonnage.atlas"));
