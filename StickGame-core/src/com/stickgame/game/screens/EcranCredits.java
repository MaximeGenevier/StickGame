...
public class EcranCredits implements Screen{
	...
	public EcranCredits(){
		...
		this.atlas = new TextureAtlas("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/UI/uiskin.atlas");
		this.skin = new Skin(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/UI/uiskin.json"), atlas);
	...
	public void show() {
		...
		musique=Gdx.audio.newMusic(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Musique/ROB (Maniac soundtrack) - Haunted.mp3"));
