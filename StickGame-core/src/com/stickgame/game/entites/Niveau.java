...
private void niveau1(){
		...
		musique=Gdx.audio.newMusic(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Musique/Naruto Shippuden OST III - Waltz of Wind and Fire.mp3"));
	...
	private void niveau2(){
		...
		this.tiledMap = new TmxMapLoader().load("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Monde/espace.tmx");
		this.tiledMapRenderer = new OrthogonalTiledMapRenderer(tiledMap);
		
		musique = Gdx.audio.newMusic(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Musique/Bleach - Fade To Black B13a.mp3"));
		musique.setVolume(0.4f);
		musique.setLooping(true);
		musique.play();
	...
	private void niveau3(){
		...
		this.tiledMap = new TmxMapLoader().load("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Monde/volcan.tmx");
		this.tiledMapRenderer = new OrthogonalTiledMapRenderer(tiledMap);
		
		musique=Gdx.audio.newMusic(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Musique/Star Wars - Anakin Vs. Obi-Wan - Battle of the Heroes.mp3"));
	...
	private void niveau4(){
		...
		this.tiledMap = new TmxMapLoader().load("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Monde/glace.tmx");
		this.tiledMapRenderer = new OrthogonalTiledMapRenderer(tiledMap);
		
		musique = Gdx.audio.newMusic(Gdx.files.internal("C:/Users/maxime/Documents/B.T.S/StickGame/android/assets/Musique/WotLK - Arthas, My Son.mp3"));
		musique.setVolume(0.4f);
		musique.setLooping(true);
		musique.play();
